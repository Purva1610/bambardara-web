...
export default {
  ...
  theme: {
    extend: {
      colors: {
        /* CEO dashboard — CSS-variable-backed theme tokens (light/dark) */
        bg: 'var(--color-bg)',
        card: 'var(--color-card)',
        text: 'var(--color-text)',
        ...
        /* Landing page — Ultra-Luxury Palette */
        'forest-green': '#0A4D2E',
        'luxury-gold': '#C9A961',
        'rich-gold': '#D4B560',
        'rose-gold': '#E8C4A0',
      ...
      boxShadow: {
        ...
        /* CEO dashboard — 'soft'/'lift' kept as the dashboard's values
           (no landing component references shadow-soft/shadow-lift). */
