        ...
        <div className="absolute inset-0 flex items-end">
          <div className="mx-auto w-full max-w-editorial px-6 pb-16 md:px-10 md:pb-20">
            ...
            <p className="mt-4 max-w-2xl font-body text-[0.95rem] font-light leading-[1.85] text-ivory-white/70 md:text-[1.05rem]">
              Become a member of the Bambardara Agrotourism Club and experience the perfect blend of nature, adventure, comfort and rural culture with exclusive benefits every year.
            </p>
